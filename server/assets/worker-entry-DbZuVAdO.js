...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BLq_dwy6.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-jcV2fEf8.js").then((n2) => n2.f),
...
var ROUTER_BASEPATH = "tao-vang-demo";
var SERVER_FN_BASE = "/tao-vang-demo/_serverFn/";
